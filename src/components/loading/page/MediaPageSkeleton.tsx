...
const MediaPageSkeleton = () => {
  return (
    <>
      ...
      <p>
        <Skeleton variant="rounded" width={230} height={22} />
      </p>
      <Skeleton variant="rounded" width={180} height={25} sx={{ margin: '10px 0 15px' }}/>
      <div className='skeleton skeleton-title' />

      <div className='playlist-detail-info album-detail-info'>
        <Skeleton variant="rounded" width={180} height={15} sx={{ margin: '15px 0' }}/>
      </div>
